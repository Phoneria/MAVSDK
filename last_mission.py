...
async def run():
    ...
    mission_items = []
    mission_items.append(MissionItem(39.87241710265067,
                                     32.73220615380094,
                                     10,
                                     10,
                                     True,
                                     ...
                                     float('nan'),
                                     float('nan')))
    mission_items.append(MissionItem(39.87244660651398,
                                     32.732491271469094,
                                     10,
                                     10,
                                     True,
                                     ...
                                     float('nan'),
                                     float('nan')))
    mission_items.append(MissionItem(39.87209255932302,
                                     32.73248806789979,
                                     10,
                                     10,
                                     True,
